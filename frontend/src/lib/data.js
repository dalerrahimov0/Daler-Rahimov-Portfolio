...
export const EXPERIENCE_FEATURED = [
  {
    ...
    evidence: ["250+ ChatGPT Enterprise users onboarded", "10+ classrooms supported"],
    points: [
      "Deployed the enterprise ChatGPT platform, onboarding 250+ users across campus.",
      "Implemented CustomGPT solutions for academic and administrative workflows.",
      "Designed Power BI dashboards that turn institutional data into actionable insights.",
      "Engineered reporting frameworks that improved visibility into student success and organizational performance.",
      "Enabled AI literacy across faculty and staff through training materials, workshops, and prompt frameworks.",
    ],
    techGroups: [
      { domain: "AI", items: ["ChatGPT Enterprise", "OpenAI", "CustomGPT", "Prompt Engineering"] },
      { domain: "Analytics", items: ["Power BI", "Reporting", "Analytics"] },
      { domain: "Enablement", items: ["Training & Workshops"] },
    ],
    highlights: [
      { text: "Enterprise AI rollout", fact: "250+ users onboarded" },
      { text: "Dashboard development", fact: "Power BI reporting" },
      { text: "Custom GPT development", fact: "10+ classrooms supported" },
      { text: "Faculty enablement", fact: "AI literacy workshops" },
      { text: "Institutional analytics", fact: "Student success visibility" },
    ],
    ...
    connector: "This enterprise AI rollout shaped the systems-first approach behind the Personal AI Architecture project — treating AI adoption as infrastructure, not a one-off tool.",
  },
  {
    id: "data-architect",
    current: false,
    ...
    evidence: ["2,484 observations modeled", "Microsoft Fabric architecture", "Power BI semantic model"],
    points: [
      "Architected data pipelines connecting Qualtrics survey data to Microsoft Fabric.",
      "Implemented ETL workflows and Power Query transformations for reliable, repeatable reporting.",
      "Designed semantic models establishing a single, trusted source of truth for the library.",
      "Deployed Power BI dashboards driving library leadership and space-planning decisions.",
      "Analyzed 2,484 library space-utilization observations to enable data-informed operational decisions.",
      "Architected the roadmap for an AI-powered knowledge infrastructure supporting information discovery.",
    ],
    techGroups: [
      { domain: "Architecture", items: ["Microsoft Fabric", "Data Architecture", "Semantic Modeling"] },
      { domain: "Development", items: ["Power Query", "ETL Pipelines", "SQL"] },
      { domain: "Analytics", items: ["Power BI", "Qualtrics"] },
    ],
    highlights: [
      { text: "Data architecture & modeling", fact: "Microsoft Fabric semantic model" },
      { text: "ETL pipeline design", fact: "Qualtrics → Fabric pipeline" },
      { text: "Power BI dashboard development", fact: "Library leadership reporting" },
      { text: "Library space utilization analytics", fact: "2,484 observations analyzed" },
      { text: "Data-informed decision support", fact: "Space-planning decisions" },
    ],
    ...
    connector: "This pipeline became the template for the production data-architecture approach carried into every analytics and AI system on this page.",
  },
];
...
export const EXPERIENCE_SUPPORTING = [
  ...
  },
  {
    ...
    period: "2022 – 2025",
    overview: "Founded and led the university's men's soccer club, overseeing operations, recruitment, fundraising, scheduling, and competitive events across 10+ states.",
...
export const TIMELINE = [
  ...
  },
  {
    ...
    org: "University of Nebraska at Kearney",
    body: "Founded and led the university's men's soccer club, managing 20+ members, organizing matches, coordinating tournaments, and leading fundraising efforts.",
  },
  {
  ...
  concepts: [
    {
      ...
      label: "Systems",
      angle: 0,
      primary: "Personal AI Architecture",
      details: ["Hodor", "Continuity over Memory"],
    },
    {
      id: "products",
      label: "Products",
      angle: 51.4,
      primary: "TajKhona",
      details: ["Founder", "Production", "Real Users"],
    },
    {
      id: "enterprise",
      label: "Enterprise",
      angle: 102.8,
      primary: "Graduate Assistant",
      details: ["ChatGPT Enterprise", "250+ Users", "10+ Classrooms"],
    },
    {
      id: "architecture",
      label: "Architecture",
      angle: 154.3,
      peers: ["PAI", "Library Analytics", "TajKhona", "Enterprise AI"],
    },
    {
      id: "research",
      label: "Research",
      angle: 205.7,
      primary: "PAI Writing Series",
      details: ["4 Parts Published", "Continuity Problem"],
    },
    {
      id: "analytics",
      label: "Analytics",
      angle: 257.1,
      primary: "Library Observations",
      details: ["2,484", "Microsoft Fabric", "Power BI"],
    },
    {
      id: "ai",
      label: "AI",
      angle: 308.6,
      primary: "UNK Chatbot",
      details: ["Pinecone + GPT", "Document-Grounded Answers"],
    },
  ],
};
